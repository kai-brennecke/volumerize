...
If you want to customize jobber more with different sinks or other commands, you should write your own job file and mount it at a custom location specified in `VOLUMERIZE_CRON_CUSTOM` (will be copied to `/root/.jobber`). More information on how to write jobber configurations can be found [here](https://dshearer.github.io/jobber/doc/v1.4/#jobfile). For example the file generated by the automated scripts could look like this:
